...
import { LuTrash2, LuTrendingDown, LuDownload } from "react-icons/lu";
          ...
          >
            <div className="flex items-center justify-between">
              ...
              <div className="flex items-center space-x-2 sm:space-x-3 flex-shrink-0">
                <div className="bg-red-50 px-2 sm:px-3 py-1 sm:py-2 rounded-lg flex items-center space-x-1 sm:space-x-2">
                  <span className="text-red-600 font-semibold text-xs">
                    - ₹{addThousandsSeparator(transaction.amount)}
                  </span>
                  <LuTrendingDown className="w-3 h-3 sm:w-4 sm:h-4 text-red-500" />
                </div>
                <button
