            ...
            <div className={`relative flex items-center transition-all duration-300 ${
                ...
                {type === "password" && showPasswordToggle && (
                    <button
                        ...
                        className="absolute right-3 p-2 text-gray-400 hover:text-purple-600 transition-colors duration-200 focus:outline-none focus:text-purple-600 disabled:cursor-not-allowed disabled:opacity-50"
